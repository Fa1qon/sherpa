...
export const MENUS: readonly MenuDef[] = [
  {
    ...
    entries: [
      { id: 'project.new', labelKey: 'chrome.items.project.new', hotkey: '⌘N' },
      ...
      SEP,
      { id: 'project.quit', labelKey: 'chrome.items.project.quit', hotkey: '⌘Q' },
    ],
  },
  {
    id: 'task',
    ...
    entries: [
      { id: 'task.new', labelKey: 'chrome.items.task.new', hotkey: '⌘T' },
      { id: 'task.newWithMethodology', labelKey: 'chrome.items.task.newWithMethodology', disabled: true },
      { id: 'task.find', labelKey: 'chrome.items.task.find', hotkey: '⌘P', disabled: true },
      SEP,
      { id: 'task.pause', labelKey: 'chrome.items.task.pause', hotkey: '⌘.', disabled: true },
      { id: 'task.resume', labelKey: 'chrome.items.task.resume', disabled: true },
      SEP,
      { id: 'task.close', labelKey: 'chrome.items.task.close', hotkey: '⌘W', disabled: true },
    ],
  },
  {
    id: 'view',
    ...
    entries: [
      { id: 'view.toggleLeftPanel', labelKey: 'chrome.items.view.toggleLeftPanel', hotkey: '⌘B' },
      { id: 'view.toggleRightPanel', labelKey: 'chrome.items.view.toggleRightPanel', hotkey: '⌘\\' },
      { id: 'view.zenMode', labelKey: 'chrome.items.view.zenMode', hotkey: '⌘K Z', disabled: true },
      SEP,
      { id: 'view.toggleArtifacts', labelKey: 'chrome.items.view.toggleArtifacts', disabled: true },
      { id: 'view.toggleStage', labelKey: 'chrome.items.view.toggleStage', hotkey: '⌘J', disabled: true },
  ...
  },
  {
    ...
    entries: [
      ...
      { id: 'help.shortcuts', labelKey: 'chrome.items.help.shortcuts', hotkey: '⌘/', disabled: true },
